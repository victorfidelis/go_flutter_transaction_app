...
class PendingTransactionStore = PendingTransactionStoreBase with _$PendingTransactionStore;

abstract class PendingTransactionStoreBase with Store {
  final GetPendingTransactionsUsecase getPendingTransactionsUsecase;

  PendingTransactionStoreBase(this.getPendingTransactionsUsecase);
